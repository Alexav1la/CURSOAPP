...
<%
    ...
    if (session.getAttribute("usuario") == null || !"estudiante".equals(session.getAttribute("rol"))) {
...
<html lang="en">
    ...
    <body>
        <div class="container mt-5 profile-container">
            <h1 style="color: black">Perfil del Estudiante</h1>
            <div class="profile-details">
                ...
                <a href="indexestudiante.jsp" class="btn btn-primary btn-back" >Volver</a>
        </div>
